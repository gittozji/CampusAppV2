 ...
 *
 */
public class TradeBuyBrowseFragment extends BaseFragment{
		/**
		 * 根View
		 */
	View mRootView;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // 创建适配器
        mAdapter = new UserGoodsAdapter(getActivity(), dataList, R.layout.item_list_buy);
	...
	private void fetchDataForRefresh(){
		...
		query1.addWhereEqualTo("isBuy",true);
