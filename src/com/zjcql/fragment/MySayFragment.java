...
*/
public class MySayFragment extends BaseFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // 创建适配器
        mAdapter = new MySayAdapter(getActivity(), dataList);
	...
	protected void fetchDataForLoad() {
		...
		// 查找user发布的信息
			BmobQuery<Says> query6 = new BmobQuery<Says>();
